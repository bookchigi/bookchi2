...
<!DOCTYPE html>
	...
	<body>
		<div class="row">
			<c:forEach items="${booklist_pop }" var="book">
			...
			<a href="page_new" class="btn btn-primary col-xs-12 col-sm-12 col-md-12 col-lg-12" data-role="button">더 많은 인기도서 보러가기</a><br>
		</div><br>
	</body>
</html>